...
public class colorpicker extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int height = (int) (manager.getDefaultDisplay().getHeight() * 0.6f);       //0.5
        int width = (int) (manager.getDefaultDisplay().getWidth() * 0.7f);          //0.7
        ColorPickerView myView = new ColorPickerView(context, height, width);
        setContentView(R.layout.colorpicker_layout);
        LinearLayout rl = (LinearLayout) findViewById(R.id.colorpickerlayout);
        rl.addView(myView);
        setTitle(title);
    }
